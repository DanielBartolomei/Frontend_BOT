...
NAV2D.OccupancyGridClientNav = function(options) {
    ...
    this.serverName = options.serverName || '/bt_navigator';//'/move_base';
    this.actionName = options.actionName || '/navigate_to_pose';//'move_base_msgs/MoveBaseAction';
    this.rootObject = options.rootObject || new createjs.Container();
    this.viewer = options.viewer;
    this.withOrientation = options.withOrientation || false;
    ...
    this.client.on('change', function() {
        ...
        that.viewer.shift(that.client.currentGrid.x, that.client.currentGrid.y);
